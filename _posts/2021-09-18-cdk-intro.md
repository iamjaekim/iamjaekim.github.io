...
Hello, I'm Jae Wook Kim. Today's topic is to introduce [CDK](https://docs.aws.amazon.com/cdk/latest/guide/home.html), another resource provisioning tool from AWS.

![AWS-CDK](../images/2021-09-17-cdk-pt1/cdk.png){: width="100%" height="100%"}

AWS CDK stands for Cloud Development Kit. It is a tool that helps you define cloud resources using conventional programming languages, rather than YAML or [HashiCorp's Terraform](https://iamjaekim.me/terraform-pt1/).  
